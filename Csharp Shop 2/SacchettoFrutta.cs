    ...
    internal class SacchettoFrutta :Prodotto
    {
        ...
        public void Mangia(int pezziMangiati)
        {
            ...
            if (this.pezziFrutta - pezziMangiati > 0)
            {
                ...
                Console.WriteLine("Gnam , ho mangiato " + pezziMangiati + " ne rimangono " + this.pezziFrutta);
            }
            else
            {

                this.pezziFrutta = 0;
                Console.WriteLine("Hai finito la bustina. " + this.pezziFrutta + " pezzi di frutta rimasti");
